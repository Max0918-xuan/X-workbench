...
function doBookSearch(){
  ...
  $('#bookSearchResults').innerHTML=`
    <a class="bsr-item" href="https://weread.qq.com/web/search?key=${kw}" target="_blank" rel="noopener">
      <span style="font-size:24px">📖</span>
      <div class="bsr-info"><b>在微信读书中搜索「${esc(q)}」</b><small>免费阅读、划线笔记、社交阅读</small></div>
